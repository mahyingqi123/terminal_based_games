 ...
 * It's damage is 142 with hit rate of 84
 * It is sellable item and is an returnable item
 * @author Jun Ng
 * @version 1.0
 * @see WeaponItem
 */
public class AxeOfGodrick extends WeaponItem implements Sellable, Returnable{

    private int sellPrice = 100;

    /**
     * Constructor of  AxeOfGodrick with fixed attributes
     */
    public AxeOfGodrick(){
        super("Axe of Godrick",'T',142,"hit",84);
    }
